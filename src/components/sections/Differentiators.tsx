    ...
    <section id="diferenciais" className="mx-auto max-w-6xl px-6 py-28">
      <div className="grid items-center gap-16 md:grid-cols-2">
        <div className="relative w-full">
          <div className="flex aspect-[5/4] w-full flex-col justify-center rounded-sm bg-gradient-to-br from-brand-900 via-brand-800 to-brand-950 p-8 text-white sm:p-10">
            <ScrollText size={28} strokeWidth={1.5} className="text-brand-200" />
            <p className="mt-6 font-serif text-2xl italic leading-snug">
              &ldquo;Fiel é o que vos chama, o qual também o fará.&rdquo;
            </p>
            <p className="mt-5 text-sm text-brand-200/70">1 Tessalonicenses 5.24</p>
          </div>
          <div className="absolute -bottom-6 -right-6 hidden h-26 w-26 items-center justify-center rounded-full bg-brand-50 text-center font-serif text-sm font-semibold text-brand-900 shadow-lg sm:flex">
            Desde
            <br />
            1986
          </div>
